const NavigationBar = () => {
  return (
    ...
    <div className="invisible lg:visible lg:flex lg:gap-5 lg:items-center">
      <div className="flex items-center gap-1">Developers<div className=""><img src="src/assets/external-link (1).png" className="w-5"/></div></div>
      <div className="flex items-center gap-1">Report Abuse<div className=""><img src="src/assets/external-link (1).png" className="w-5"/></div></div>
